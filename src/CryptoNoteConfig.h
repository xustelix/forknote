// Copyright (c) 2012-2017, The CryptoNote developers, The Bytecoin developers, Xustelix Devs
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 182; //addresses start with XS
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 10;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 60 * 60 * 2;

const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 60;

// MONEY_SUPPLY - total number coins to be generated           UINT64_C(10000000000000000000);

const uint64_t MONEY_SUPPLY                                  = UINT64_C(1200000000000000); //12m 
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 20000 //100000; //size of block (bytes) after which reward for block calculated using block size
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V2  = 20000;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V1  = 20000;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_CURRENT = CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE;
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 600;
const size_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT              = 8;
const uint64_t MINIMUM_FEE                                   = UINT64_C(10000000); //UINT64_C(1000000);    // pow(10, 6)
const uint64_t DEFAULT_DUST_THRESHOLD                        = MINIMUM_FEE; //UINT64_C(1000000);    // pow(10, 6)
...
const char     GENESIS_COINBASE_TX_HEX[]                     = "013c01ff000196a6b68801029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101c8e00da0cd97bec2bf399959b544ea4aaede831fead30cb19f174987558d9d75";
} // parameters

const char     CRYPTONOTE_NAME[]                             = "xustelix";
...
const int      P2P_DEFAULT_PORT                              =  17920;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              =  17921;
...
const char* const SEED_NODES[] = { "144.217.7.88:17920", "201.39.92.96:17920" };
